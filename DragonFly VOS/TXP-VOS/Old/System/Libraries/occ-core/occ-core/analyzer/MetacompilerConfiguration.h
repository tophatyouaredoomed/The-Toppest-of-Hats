#ifndef guard_occ_core_analyzer_MetacompilerConfiguration_h
#define guard_occ_core_analyzer_MetacompilerConfiguration_h
...
public:    
    ...
    public:
        ...
        {
           // in order of compilation problems with gcc 3.4.2 
	   // I removed the std::swap version with an own 
	   // handcoded version of swap :) 
	   // Vinzenz Feenstra
           std::auto_ptr<IteratorIface> tmp = impl_;
	   impl_ = iter.impl_;
	   iter.impl_ = tmp;
	   // std::swap(impl_, iter.impl_); // removed causes compilation errors with gcc-3.4.2 
            return *this;
         }
...
#endif /* ! guard_occ_core_analyzer_MetacompilerConfiguration_h */
