#ifndef guard_occ_core_analyzer_TheMetaclassRegistry_h
#define guard_occ_core_analyzer_TheMetaclassRegistry_h
...
#endif /* ! guard_occ_core_analyzer_TheMetaclassRegistry_h */
