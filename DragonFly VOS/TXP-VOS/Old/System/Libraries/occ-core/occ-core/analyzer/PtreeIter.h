#ifndef guard_occ_core_analyzer_PtreeIter_h
#define guard_occ_core_analyzer_PtreeIter_h
...
class PtreeIter : public LightObject {
public:
...
#endif /* ! guard_occ_core_analyzer_PtreeIter_h */
