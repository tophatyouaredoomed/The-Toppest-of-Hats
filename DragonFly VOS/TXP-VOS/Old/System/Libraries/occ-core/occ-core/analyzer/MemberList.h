#ifndef guard_occ_core_analyzer_MemberList_h
#define guard_occ_core_analyzer_MemberList_h
...
class MemberList : public LightObject {
public:
    struct Mem {
	Class* supplying;
	Ptree* definition;
...
#endif /* ! guard_occ_core_analyzer_MemberList_h */
