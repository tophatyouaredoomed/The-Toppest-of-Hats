#ifndef guard_occ_core_parser_PtreeDeclarator_h
#define guard_occ_core_parser_PtreeDeclarator_h
...
public:
    ...
    const char* DumpName() const { return "PtreeDeclarator"; }
...
#endif /* ! guard_occ_core_parser_PtreeDeclarator_h */
