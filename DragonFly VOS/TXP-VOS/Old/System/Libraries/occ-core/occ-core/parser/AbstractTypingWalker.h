#ifndef guard_occ_core_parser_AbstractTypingWalker_h
#define guard_occ_core_parser_AbstractTypingWalker_h
...
#endif /* ! guard_occ_core_parser_AbstractTypingWalker_h */
