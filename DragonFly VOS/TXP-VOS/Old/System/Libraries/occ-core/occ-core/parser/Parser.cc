...
#include <occ-core/parser/ParseErrorMsg.h>
#include <occ-core/parser/ErrorLog.h>
#include <occ-core/parser/SourceLocation.h>
#include <occ-core/parser/NullMetaclassLoader.h>
...
bool Parser::rDefinition(Ptree*& p)
{
	...
	Ptree* c = PtreeUtil::String2Ptree(lex->GetComments2());
...
bool Parser::rTemplateArgs(Ptree*& temp_args, Encoding& encode)
{
    ...
    for(;;){
	Ptree* a;
	Lex::TokenIterator pos = lex->Save();
	type_encode.Clear();
...
bool Parser::rClassSpec(Ptree*& spec, Encoding& encode)
{
    ...
    Ptree* comments = PtreeUtil::String2Ptree(lex->GetComments());
...
bool Parser::rClassMember(Ptree*& mem)
{
	...
	Lex::TokenIterator pos = lex->Save();
	Ptree* comments = PtreeUtil::String2Ptree(lex->GetComments2());
	if(rDeclaration(mem)) {
