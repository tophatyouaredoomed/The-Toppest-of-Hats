#ifndef guard_occ_core_parser_PtreeArray_h
#define guard_occ_core_parser_PtreeArray_h
...
public:
    ...
    void Clear() { num = 0; }
    Ptree* All();
    const char* DumpName() const { return "PtreeArray"; }
...
#endif /* ! guard_occ_core_parser_PtreeArray_h */
