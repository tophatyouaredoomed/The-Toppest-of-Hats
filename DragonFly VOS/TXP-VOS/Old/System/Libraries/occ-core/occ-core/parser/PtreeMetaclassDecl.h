#ifndef guard_occ_core_parser_PtreeMetaclassDecl_h
#define guard_occ_core_parser_PtreeMetaclassDecl_h
...
public:
    ...
    const char* DumpName() const { return "PtreeMetaclassDecl"; }
};

}

#endif /* ! guard_occ_core_parser_PtreeMetaclassDecl_h */
