#ifndef guard_occ_core_parser_PtreeBrace_h
#define guard_occ_core_parser_PtreeBrace_h
...
public:
    ...
    const char* DumpName() const { return "PtreeBrace"; }
};

}

#endif /* ! guard_occ_core_parser_PtreeBrace_h */
