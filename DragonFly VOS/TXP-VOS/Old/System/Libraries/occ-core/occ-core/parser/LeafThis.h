#ifndef guard_occ_core_parser_LeafThis_h
#define guard_occ_core_parser_LeafThis_h
...
#include <occ-core/parser/LeafReserved.h>
...
public:
    ...
    const char* DumpName() const { return "LeafThis"; }
};

}

#endif /* ! guard_occ_core_parser_LeafThis_h */
