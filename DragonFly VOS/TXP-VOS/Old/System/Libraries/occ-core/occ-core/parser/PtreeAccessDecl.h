#ifndef guard_occ_core_parser_PtreeAccessDecl_h
#define guard_occ_core_parser_PtreeAccessDecl_h
...
public:
    ...
    const char* DumpName() const { return "PtreeAccessDecl"; }
};

}

#endif /* ! guard_occ_core_parser_PtreeAccessDecl_h */
