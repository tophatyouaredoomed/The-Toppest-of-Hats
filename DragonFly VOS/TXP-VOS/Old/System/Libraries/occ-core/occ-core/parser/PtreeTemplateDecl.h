#ifndef guard_occ_core_parser_PtreeTemplateDecl_h
#define guard_occ_core_parser_PtreeTemplateDecl_h
...
public:
    ...
    const char* DumpName() const { return "PtreeTemplateDecl"; }
};

}

#endif /* ! guard_occ_core_parser_PtreeTemplateDecl_h */
