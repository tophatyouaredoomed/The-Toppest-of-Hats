#ifndef guard_occ_core_parser_PtreeAccessSpec_h
#define guard_occ_core_parser_PtreeAccessSpec_h
...
public:
    ...
    const char* DumpName() const { return "PtreeAccessSpec"; }
};

}

#endif /* ! guard_occ_core_parser_PtreeAccessSpec_h */
