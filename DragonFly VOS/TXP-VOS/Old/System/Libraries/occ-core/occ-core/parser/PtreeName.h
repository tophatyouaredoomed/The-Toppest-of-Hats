#ifndef guard_occ_core_parser_PtreeName_h
#define guard_occ_core_parser_PtreeName_h
...
public:
    ...
    const char* DumpName() const { return "PtreeName"; }
...
#endif /* ! guard_occ_core_parser_PtreeName_h */
