...
public:
    ...
    const char* DumpName() const { return "Ptree%keyword%Expr"; }
};
...
public:
    ...
    const char* DumpName() const { return "Leaf%keyword%"; }
};
...
echo '#include <occ-core/parser/NonLeaf.h>' >>$header
echo '#include <occ-core/parser/LeafReserved.h>' >>$header
echo '#include <occ-core/parser/token-names.h>' >>$header
echo "// DO NOT EDIT!!! Generated with \`$cmdline'" >>$header
echo "// DO NOT EDIT!!! Generated with \`$cmdline'" >>$implementation
echo '#include <occ-core/parser/ptree-generated.h>' >>$implementation
echo '#include <occ-core/parser/AbstractTypingWalker.h>' >>$implementation
echo '#include <occ-core/parser/AbstractTranslatingWalker.h>' >>$implementation
