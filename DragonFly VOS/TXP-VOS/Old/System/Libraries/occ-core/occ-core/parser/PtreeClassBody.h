#ifndef guard_occ_core_parser_PtreeClassBody_h
#define guard_occ_core_parser_PtreeClassBody_h
...
public:
    ...
    const char* DumpName() const { return "PtreeClassBody"; }
};

}

#endif /* ! guard_occ_core_parser_PtreeClassBody_h */
