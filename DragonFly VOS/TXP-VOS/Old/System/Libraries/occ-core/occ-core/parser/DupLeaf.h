#ifndef guard_occ_core_parser_DupLeaf_h
#define guard_occ_core_parser_DupLeaf_h
...
public:
    ...
    const char* DumpName() const { return "DupLeaf"; }
};

}

#endif /* ! guard_occ_core_parser_DupLeaf_h */
