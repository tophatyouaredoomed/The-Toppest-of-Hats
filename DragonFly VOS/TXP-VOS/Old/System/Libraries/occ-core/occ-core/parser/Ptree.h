#ifndef guard_occ_core_parser_Ptree_h
#define guard_occ_core_parser_Ptree_h
...
public:
    ...
    virtual const char* DumpName() const { return "Ptree"; }
...
#endif /* ! guard_occ_core_parser_Ptree_h */
