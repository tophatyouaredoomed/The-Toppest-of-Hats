#ifndef guard_occ_core_parser_PtreeTemplateInstantiation_h
#define guard_occ_core_parser_PtreeTemplateInstantiation_h
...
public:
    ...
    const char* DumpName() const { return "PtreeTemplateInstantiation"; }
};

}

#endif /* ! guard_occ_core_parser_PtreeTemplateInstantiation_h */
