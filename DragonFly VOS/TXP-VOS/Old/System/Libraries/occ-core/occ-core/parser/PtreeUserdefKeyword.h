#ifndef guard_occ_core_parser_PtreeUserdefKeyword_h
#define guard_occ_core_parser_PtreeUserdefKeyword_h
...
public:
    ...
    int What();
    const char* DumpName() const { return "PtreeUserdefKeyword"; }
};
...
#endif /* ! guard_occ_core_parser_PtreeUserdefKeyword_h */
