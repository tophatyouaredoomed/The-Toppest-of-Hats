#ifndef guard_occ_core_parser_PtreeLinkageSpec_h
#define guard_occ_core_parser_PtreeLinkageSpec_h
...
public:
    ...
    const char* DumpName() const { return "PtreeLinkageSpec"; }
};

}

#endif /* ! guard_occ_core_parser_PtreeLinkageSpec_h */
