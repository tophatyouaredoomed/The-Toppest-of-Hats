#ifndef guard_occ_core_parser_PtreeUtil_h
#define guard_occ_core_parser_PtreeUtil_h
...
namespace PtreeUtil
{
    ...
    */
    ...
    /** Returns true iff p reprsents <code>n</code>-character prefix of <code>str</code>
        @pre p is a leaf
      */
    ...
    */
    ...
    Ptree* String2Ptree(const std::string&);
}

}

#endif /* ! guard_occ_core_parser_PtreeUtil_h */
