#ifndef guard_occ_core_parser_PtreeDeclaration_h
#define guard_occ_core_parser_PtreeDeclaration_h
...
public:
    ...
    const char* DumpName() const { return "PtreeDeclaration"; }
};

}

#endif /* ! guard_occ_core_parser_PtreeDeclaration_h */
