#ifndef guard_occ_core_parser_LeafReserved_h
#define guard_occ_core_parser_LeafReserved_h
...
public:
    ...
    const char* DumpName() const { return "LeafReserved"; }
};

}

#endif /* ! guard_occ_core_parser_LeafReserved_h */
