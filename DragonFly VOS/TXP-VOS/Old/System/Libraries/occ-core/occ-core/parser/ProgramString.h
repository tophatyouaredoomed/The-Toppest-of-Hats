#ifndef guard_occ_core_parser_ProgramString_h
#define guard_occ_core_parser_ProgramString_h
...
public:
    ...
    ~ProgramString();
    void Clear() { buf[0] = '\0'; }
    unsigned Length() { return str_length; }
...
#endif /* ! guard_occ_core_parser_ProgramString_h */
