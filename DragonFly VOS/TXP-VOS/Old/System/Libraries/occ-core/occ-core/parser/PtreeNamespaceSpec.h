#ifndef guard_occ_core_parser_PtreeNamespaceSpec_h
#define guard_occ_core_parser_PtreeNamespaceSpec_h
...
public:
    ...
    const char* DumpName() const { return "PtreeNamespaceSpec"; }
};

}

#endif /* ! guard_occ_core_parser_PtreeNamespaceSpec_h */
