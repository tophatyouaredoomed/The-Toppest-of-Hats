#ifndef guard_occ_core_parser_LeafName_h
#define guard_occ_core_parser_LeafName_h
...
public:
    ...
    const char* DumpName() const { return "LeafName"; }
};

}

#endif /* ! guard_occ_core_parser_LeafName_h */
