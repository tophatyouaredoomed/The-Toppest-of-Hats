#ifndef guard_occ_core_parser_PtreeUserAccessSpec_h
#define guard_occ_core_parser_PtreeUserAccessSpec_h
...
public:
    ...
    const char* DumpName() const { return "PtreeUserAccessSpec"; }
};

}

#endif /* ! guard_occ_core_parser_PtreeUserAccessSpec_h */
