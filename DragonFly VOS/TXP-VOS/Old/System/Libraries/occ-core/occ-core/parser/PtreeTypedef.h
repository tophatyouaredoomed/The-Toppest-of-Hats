#ifndef guard_occ_core_parser_PtreeTypedef_h
#define guard_occ_core_parser_PtreeTypedef_h
...
public:
    ...
    const char* DumpName() const { return "PtreeTypedef"; }
};

}

#endif /* ! guard_occ_core_parser_PtreeTypedef_h */
