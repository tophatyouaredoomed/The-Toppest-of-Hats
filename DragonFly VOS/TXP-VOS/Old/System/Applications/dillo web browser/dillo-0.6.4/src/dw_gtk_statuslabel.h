...
#define GTK_STATUSLABEL(obj)          GTK_CHECK_CAST (obj, Dw_gtk_statuslabel_get_type (), GtkLabel)
#define GTK_STATUSLABEL_CLASS(klass)  GTK_CHECK_CLASS_CAST (klass, Dw_gtk_statuslabel_get_type (), GtkLabelClass)
#define GTK_IS_STATUSLABEL(obj)       GTK_CHECK_TYPE (obj, Dw_gtk_statuslabel_get_type ())
