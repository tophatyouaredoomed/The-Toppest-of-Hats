...
DwWidget* a_Dw_list_item_new (DwListItem *ref_list_item)
{
   ...
   Dw_aligned_page_set_ref_page (DW_ALIGNED_PAGE (object),
                                        ...
                                        gint32 value)
{
   ...
   page->inner_padding = value;
   page->line1_offset = - Dw_list_item_get_value (aligned_page);
   Dw_widget_queue_resize (DW_WIDGET (aligned_page), 0, TRUE);
}
                                      ...
                                      DwStyle *style)
{
   ...
   Dw_aligned_page_update_value (DW_ALIGNED_PAGE (list_item));
}
